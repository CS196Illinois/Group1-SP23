...
public class MainActivity extends AppCompatActivity {
    ...
    public void setExerciseGoal(int goal) {
        this.exercise_goal = goal;
        System.out.println(this.exercise_goal);
    }

    public int getExerciseGoal() {
        return this.exercise_goal;
    }

    public void setDrinkGoal(int goal) {
        this.drink_goal = goal;
        System.out.println(this.drink_goal);
    }
